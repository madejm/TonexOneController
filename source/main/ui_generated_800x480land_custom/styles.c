...
void init_style_button_effect_MAIN_DEFAULT(lv_style_t *style) {
    init_style_button_preset_MAIN_DEFAULT(style);
...
lv_style_t *get_style_button_effect_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_button_effect_MAIN_DEFAULT(style);
    }
    return style;
};

void init_style_button_effect_MAIN_PRESSED(lv_style_t *style) {
    init_style_button_preset_MAIN_PRESSED(style);
...
lv_style_t *get_style_button_effect_MAIN_PRESSED() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_button_effect_MAIN_PRESSED(style);
    }
    return style;
};

void init_style_button_effect_MAIN_CHECKED(lv_style_t *style) {
    init_style_button_preset_MAIN_CHECKED(style);
...
lv_style_t *get_style_button_effect_MAIN_CHECKED() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_button_effect_MAIN_CHECKED(style);
    }
    return style;
};
...
void add_style_button_effect(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_button_effect_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_button_effect_MAIN_PRESSED(), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_add_style(obj, get_style_button_effect_MAIN_CHECKED(), LV_PART_MAIN | LV_STATE_CHECKED);
};

void remove_style_button_effect(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_button_effect_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_button_effect_MAIN_PRESSED(), LV_PART_MAIN | LV_STATE_PRESSED);
    lv_obj_remove_style(obj, get_style_button_effect_MAIN_CHECKED(), LV_PART_MAIN | LV_STATE_CHECKED);
};
...
lv_style_t *get_style_container_preset_list_cell_MAIN_CHECKED() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_container_preset_list_cell_MAIN_CHECKED(style);
    }
    return style;
};
...
void add_style_container_preset_list_cell(lv_obj_t *obj) {
    ...
    lv_obj_add_style(obj, get_style_container_preset_list_cell_MAIN_CHECKED(), LV_PART_MAIN | LV_STATE_CHECKED);
};
...
void remove_style_container_preset_list_cell(lv_obj_t *obj) {
    ...
    lv_obj_remove_style(obj, get_style_container_preset_list_cell_MAIN_CHECKED(), LV_PART_MAIN | LV_STATE_CHECKED);
};
...
lv_style_t *get_style_dropdown_list_sub_settings_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_dropdown_list_sub_settings_MAIN_DEFAULT(style);
    }
    return style;
};
...
lv_style_t *get_style_dropdown_list_sub_settings_SELECTED_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_dropdown_list_sub_settings_SELECTED_DEFAULT(style);
    }
    return style;
};
...
lv_style_t *get_style_dropdown_list_sub_settings_SELECTED_CHECKED() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_dropdown_list_sub_settings_SELECTED_CHECKED(style);
    }
    return style;
};
...
void add_style_dropdown_list_sub_settings(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_dropdown_list_sub_settings_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_dropdown_list_sub_settings_SELECTED_DEFAULT(), LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_dropdown_list_sub_settings_SELECTED_CHECKED(), LV_PART_SELECTED | LV_STATE_CHECKED);
};

void remove_style_dropdown_list_sub_settings(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_dropdown_list_sub_settings_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_dropdown_list_sub_settings_SELECTED_DEFAULT(), LV_PART_SELECTED | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_dropdown_list_sub_settings_SELECTED_CHECKED(), LV_PART_SELECTED | LV_STATE_CHECKED);
};
...
lv_style_t *get_style_textarea_settings_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_textarea_settings_MAIN_DEFAULT(style);
    }
    return style;
};
...
lv_style_t *get_style_textarea_settings_TEXTAREA_PLACEHOLDER_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_textarea_settings_TEXTAREA_PLACEHOLDER_DEFAULT(style);
    }
    return style;
};
...
void add_style_textarea_settings(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_textarea_settings_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_textarea_settings_TEXTAREA_PLACEHOLDER_DEFAULT(), LV_PART_TEXTAREA_PLACEHOLDER | LV_STATE_DEFAULT);
};

void remove_style_textarea_settings(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_textarea_settings_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_textarea_settings_TEXTAREA_PLACEHOLDER_DEFAULT(), LV_PART_TEXTAREA_PLACEHOLDER | LV_STATE_DEFAULT);
};
...
lv_style_t *get_style_checkbox_settings_INDICATOR_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_checkbox_settings_INDICATOR_DEFAULT(style);
    }
    return style;
};
...
lv_style_t *get_style_checkbox_settings_INDICATOR_CHECKED() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_checkbox_settings_INDICATOR_CHECKED(style);
    }
    return style;
};
...
void add_style_checkbox_settings(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_checkbox_settings_INDICATOR_DEFAULT(), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_checkbox_settings_INDICATOR_CHECKED(), LV_PART_INDICATOR | LV_STATE_CHECKED);
};

void remove_style_checkbox_settings(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_checkbox_settings_INDICATOR_DEFAULT(), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_checkbox_settings_INDICATOR_CHECKED(), LV_PART_INDICATOR | LV_STATE_CHECKED);
};
...
lv_style_t *get_style_keyboard_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_keyboard_MAIN_DEFAULT(style);
    }
    return style;
};
...
lv_style_t *get_style_keyboard_ITEMS_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_keyboard_ITEMS_DEFAULT(style);
    }
    return style;
};
...
lv_style_t *get_style_keyboard_ITEMS_CHECKED() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_mem_alloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_keyboard_ITEMS_CHECKED(style);
    }
    return style;
};
...
void add_style_keyboard(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_keyboard_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_keyboard_ITEMS_DEFAULT(), LV_PART_ITEMS | LV_STATE_DEFAULT);
    lv_obj_add_style(obj, get_style_keyboard_ITEMS_CHECKED(), LV_PART_ITEMS | LV_STATE_CHECKED);
};

void remove_style_keyboard(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_keyboard_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_keyboard_ITEMS_DEFAULT(), LV_PART_ITEMS | LV_STATE_DEFAULT);
    lv_obj_remove_style(obj, get_style_keyboard_ITEMS_CHECKED(), LV_PART_ITEMS | LV_STATE_CHECKED);
};
