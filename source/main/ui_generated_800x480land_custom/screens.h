...
typedef struct _objects_t {
    ...
    lv_obj_t *obj3;
    lv_obj_t *ui_noise_gate_threshold_arc;
    lv_obj_t *ui_noise_gate_threshold_value;
    lv_obj_t *obj4;
    lv_obj_t *ui_noise_gate_release_arc;
    lv_obj_t *ui_noise_gate_release_value;
    lv_obj_t *obj5;
    lv_obj_t *ui_noise_gate_depth_arc;
    ...
    lv_obj_t *obj8;
    lv_obj_t *ui_compressor_threshold_arc;
    lv_obj_t *ui_compressor_threshold_value;
    lv_obj_t *obj9;
    lv_obj_t *ui_compressor_gain_arc;
    lv_obj_t *ui_compressor_gain_value;
    lv_obj_t *obj10;
    lv_obj_t *ui_compressor_attack_arc;
    ...
    lv_obj_t *ui_next_bank_button;
    lv_obj_t *ui_effect_button_small6;
    lv_obj_t *ui_effect_label_small6;
    lv_obj_t *ui_preset_button1;
    lv_obj_t *ui_preset_label1;
    lv_obj_t *ui_preset_index1;
    lv_obj_t *ui_effect_button_small1;
    lv_obj_t *ui_effect_label_small1;
    lv_obj_t *ui_preset_button2;
    lv_obj_t *ui_preset_label2;
    lv_obj_t *ui_preset_index2;
    lv_obj_t *ui_effect_button_small2;
    lv_obj_t *ui_effect_label_small2;
    lv_obj_t *ui_preset_button3;
    lv_obj_t *ui_preset_label3;
    lv_obj_t *ui_preset_index3;
    lv_obj_t *ui_effect_button_small3;
    lv_obj_t *ui_effect_label_small3;
    lv_obj_t *ui_preset_button4;
    lv_obj_t *ui_preset_label4;
    lv_obj_t *ui_preset_index4;
    lv_obj_t *ui_effect_button_small4;
    lv_obj_t *ui_effect_label_small4;
    lv_obj_t *ui_previous_bank_button;
    lv_obj_t *ui_effect_button_small5;
    lv_obj_t *ui_effect_label_small5;
    lv_obj_t *ui_buttons_alt;
    lv_obj_t *ui_effect_button_small7_alt;
    lv_obj_t *ui_effect_label_small7_alt;
    lv_obj_t *ui_effect_button7_alt;
    lv_obj_t *ui_effect_label7_alt;
    lv_obj_t *ui_effect_label7_alt_off;
    lv_obj_t *ui_effect_label7_alt_on;
    lv_obj_t *ui_effect_button_small8_alt;
    lv_obj_t *ui_effect_label_small8_alt;
    lv_obj_t *ui_effect_button8_alt;
    lv_obj_t *ui_effect_label8_alt;
    lv_obj_t *ui_effect_label8_alt_off;
    lv_obj_t *ui_effect_label8_alt_on;
    lv_obj_t *ui_effect_button_small6_alt;
    lv_obj_t *ui_effect_label_small6_alt;
    lv_obj_t *ui_effect_button6_alt;
    lv_obj_t *ui_effect_label6_alt;
    lv_obj_t *ui_effect_label6_alt_off;
    lv_obj_t *ui_effect_label6_alt_on;
    lv_obj_t *ui_effect_button_small1_alt;
    lv_obj_t *ui_effect_label_small1_alt;
    lv_obj_t *ui_effect_button1_alt;
    lv_obj_t *ui_effect_label1_alt;
    lv_obj_t *ui_effect_label1_alt_off;
    lv_obj_t *ui_effect_label1_alt_on;
    lv_obj_t *ui_effect_button_small2_alt;
    lv_obj_t *ui_effect_label_small2_alt;
    lv_obj_t *ui_effect_button2_alt;
    lv_obj_t *ui_effect_label2_alt;
    lv_obj_t *ui_effect_label2_alt_off;
    lv_obj_t *ui_effect_label2_alt_on;
    lv_obj_t *ui_effect_button_small3_alt;
    lv_obj_t *ui_effect_label_small3_alt;
    lv_obj_t *ui_effect_button3_alt;
    lv_obj_t *ui_effect_label3_alt;
    lv_obj_t *ui_effect_label3_alt_off;
    lv_obj_t *ui_effect_label3_alt_on;
    lv_obj_t *ui_effect_button_small4_alt;
    lv_obj_t *ui_effect_label_small4_alt;
    lv_obj_t *ui_effect_button4_alt;
    lv_obj_t *ui_effect_label4_alt;
    lv_obj_t *ui_effect_label4_alt_off;
    lv_obj_t *ui_effect_label4_alt_on;
    lv_obj_t *ui_effect_button_small5_alt;
    lv_obj_t *ui_effect_label_small5_alt;
    lv_obj_t *ui_effect_button5_alt;
    lv_obj_t *ui_effect_label5_alt;
    lv_obj_t *ui_effect_label5_alt_off;
    lv_obj_t *ui_effect_label5_alt_on;
