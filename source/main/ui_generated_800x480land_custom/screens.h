...
typedef struct _objects_t {
    ...
    lv_obj_t *ui_fs_buttons_top;
    lv_obj_t *ui_alt_button;
    lv_obj_t *ui_alt_button_label;
    lv_obj_t *ui_fs_button6;
    lv_obj_t *ui_fs_button6_label;
    lv_obj_t *ui_fs_button7;
    lv_obj_t *ui_fs_button7_label;
    lv_obj_t *ui_fs_button5;
    lv_obj_t *ui_fs_button5_label;
    lv_obj_t *ui_fs_buttons_bottom;
    lv_obj_t *ui_fs_button0;
    lv_obj_t *ui_fs_button0_label;
    lv_obj_t *ui_fs_button1;
    lv_obj_t *ui_fs_button1_label;
    lv_obj_t *ui_fs_button2;
    lv_obj_t *ui_fs_button2_label;
    lv_obj_t *ui_fs_button3;
    lv_obj_t *ui_fs_button3_label;
    lv_obj_t *ui_fs_button4;
    lv_obj_t *ui_fs_button4_label;
    lv_obj_t *ui_preset_buttons;
    lv_obj_t *ui_preset_button1;
    lv_obj_t *ui_preset_image1;
    lv_obj_t *ui_preset_button2;
    lv_obj_t *ui_preset_image2;
    lv_obj_t *ui_preset_button3;
    lv_obj_t *ui_preset_image3;
    lv_obj_t *ui_preset_button4;
    lv_obj_t *ui_preset_image4;
    lv_obj_t *ui_previous_bank;
    lv_obj_t *ui_next_bank;
