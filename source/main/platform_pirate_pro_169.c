...
#if CONFIG_TONEX_CONTROLLER_HARDWARE_PLATFORM_PIRATE_MIDI_POLAR_PRO

static const char *TAG = "platform_piratepro";

#define POLAR_PRO_240_280_LCD_H_RES               (240)
#define POLAR_PRO_240_280_LCD_V_RES               (280)

/* LCD settings */
#define POLAR_PRO_240_280_LCD_SPI_NUM             (SPI3_HOST)
...
#define POLAR_PRO_240_280_LCD_BL_ON_LEVEL         (1)
...
{
#if CONFIG_TONEX_CONTROLLER_POLAR_PRO_169_LANDSCAPE    
    // landscape mode    
...
{    
    ...
    gpio_config_t bk_gpio_config = {
        ...
        .pin_bit_mask = 1ULL << POLAR_PRO_240_280_LCD_GPIO_BL};
    ESP_ERROR_CHECK(gpio_config(&bk_gpio_config));

    /* LCD initialization */
    ESP_LOGD(TAG, "Initialize SPI bus");
    const spi_bus_config_t buscfg = {
        .sclk_io_num = POLAR_PRO_240_280_LCD_GPIO_SCLK,
        .mosi_io_num = POLAR_PRO_240_280_LCD_GPIO_MOSI,
        .miso_io_num = GPIO_NUM_NC,
        .quadwp_io_num = GPIO_NUM_NC,
        .quadhd_io_num = GPIO_NUM_NC,
        // note here: this value needs to be: POLAR_PRO_240_280_LCD_H_RES * POLAR_PRO_240_280_LCD_DRAW_BUFF_HEIGHT * sizeof(uint16_t)
    ...
    spi_bus_initialize(POLAR_PRO_240_280_LCD_SPI_NUM, &buscfg, SPI_DMA_CH_AUTO);

    ESP_LOGD(TAG, "Install panel IO");
    const esp_lcd_panel_io_spi_config_t io_config = {
        .dc_gpio_num = POLAR_PRO_240_280_LCD_GPIO_DC,
        .cs_gpio_num = POLAR_PRO_240_280_LCD_GPIO_CS,
        .pclk_hz = POLAR_PRO_240_280_LCD_PIXEL_CLK_HZ,
        .lcd_cmd_bits = POLAR_PRO_240_280_LCD_CMD_BITS,
        .lcd_param_bits = POLAR_PRO_240_280_LCD_PARAM_BITS,
        .spi_mode = 0,
        .trans_queue_depth = 10,
    };
    esp_lcd_new_panel_io_spi((esp_lcd_spi_bus_handle_t)POLAR_PRO_240_280_LCD_SPI_NUM, &io_config, &lcd_io);
    ...
    // LCD backlight on 
    gpio_set_level(POLAR_PRO_240_280_LCD_GPIO_BL, POLAR_PRO_240_280_LCD_BL_ON_LEVEL);
    ...
    buf1 = heap_caps_malloc(POLAR_PRO_240_280_LCD_H_RES * 32 * sizeof(lv_color_t), MALLOC_CAP_SPIRAM);
    assert(buf1);
    buf2 = heap_caps_malloc(POLAR_PRO_240_280_LCD_H_RES * 32 * sizeof(lv_color_t), MALLOC_CAP_SPIRAM);
    assert(buf2);
    lv_disp_draw_buf_init(&disp_buf, buf1, buf2, POLAR_PRO_240_280_LCD_H_RES * 32);

    ESP_LOGI(TAG, "Register display driver to LVGL");
    lv_disp_drv_init(disp_drv);
    disp_drv->hor_res = POLAR_PRO_240_280_LCD_H_RES;
    disp_drv->ver_res = POLAR_PRO_240_280_LCD_V_RES;
    ...
    const esp_lcd_touch_config_t tp_cfg = {
        .x_max = POLAR_PRO_240_280_LCD_H_RES,
        .y_max = POLAR_PRO_240_280_LCD_V_RES,
...
#endif  // TONEX_CONTROLLER_HAS_TOUCH  
...
#endif //CONFIG_TONEX_CONTROLLER_HARDWARE_PLATFORM_PIRATE_MIDI_POLAR_PRO